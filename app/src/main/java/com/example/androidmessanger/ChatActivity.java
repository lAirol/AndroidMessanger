...
import com.example.androidmessanger.databinding.ActivityChatBinding;
import com.example.androidmessanger.message.Message;
import com.example.androidmessanger.message.MessagesAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sendMessageBtn.setOnClickListener(v -> {
            ...
            if(message.isEmpty()){
                Toast.makeText(this,"Пустое сообщенько",Toast.LENGTH_SHORT).show();
                return;
            }
